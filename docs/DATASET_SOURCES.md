...
每条来源均核实过规模与许可（2026-09 核查）。许可代码含义见
...
| 农产品分选 | Fruits-360 — github.com/Horea94/Fruit-Images-Dataset | 约 90,483 图 / 130+ 类 | 研究教学 |
| 果园果实计数 | MinneApple — arXiv:1905.11451 | 1,349 图 / 7 万+ 实例 | 学术研究 |
...
## 暂无公开数据集、明确标注为演示样例的卡片

包裹传送带、林木健康、蜂箱巡检、隧道设施、违法建设、建筑垃圾渣土、户外广告招牌、
河道水域污染、园林绿化、交安设施（护栏类）、市政设施（井盖/路灯类）、
工地扬尘/围挡类、违停/应急车道类。

上述卡片已在 `source` / `method` / `limitations` 字段中如实标注
