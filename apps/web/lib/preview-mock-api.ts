...
export const previewRuns: TrainingRun[] = [
  ...
  },
  {
    ...
    resource_usage: { schema_version: "1.0", runtime_image: "ultralytics@sha256:demo", device: "cpu", duration_seconds: 4200, train_assets: 96, validation_assets: 24 },
  ...
  },
  {
    ...
    resource_usage: { schema_version: "1.0", runtime_image: "ultralytics@sha256:demo", device: "cpu", duration_seconds: 5400, train_assets: 64, validation_assets: 16 },
  ...
  },
  {
    ...
    resource_usage: { schema_version: "1.0", runtime_image: "ultralytics@sha256:demo", device: "cpu", duration_seconds: 6300, train_assets: 80, validation_assets: 20 },
